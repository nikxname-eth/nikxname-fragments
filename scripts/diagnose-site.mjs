...
const CHECKS = [
  ...
  { id: 'frag-21-instance', label: 'Fragment 21 Manifold instance', pattern: /4039002352/ },
  ...
  { id: 'banner-gif', label: 'Stage II banner GIFs', pattern: /BannerGridDark-21-web\.gif[\s\S]{0,200}BannerGridLight-21-web\.gif/ },
  { id: 'site-audio', label: 'Site audio loop', pattern: /TogetherItBloomsAudio\.mp3/ },
  { id: 'asset-version', label: 'Site asset cache version', pattern: /20260727f21a/ },
  { id: 'canvas-state-latest', label: 'Theatre canvas state stills (latest CDN)', pattern: /canvasstatedark-21\.jpg|canvasstatelight-21\.jpg/ },
