...
const CHECKS = [
  ...
  { id: 'frag-23-instance', label: 'Fragment 23 Manifold instance', pattern: /4037951728/ },
  ...
  { id: 'banner-gif', label: 'Stage II banner GIFs', pattern: /BannerGridDark-23-web\.gif[\s\S]{0,200}BannerGridLight-23-web\.gif/ },
  { id: 'site-audio', label: 'Site audio loop', pattern: /TogetherItBloomsAudio\.mp3/ },
  { id: 'asset-version', label: 'Site asset cache version', pattern: /20260731f23a/ },
  { id: 'canvas-state-latest', label: 'Theatre canvas state stills (latest CDN)', pattern: /canvasstatedark-23\.jpg|canvasstatelight-23\.jpg/ },
