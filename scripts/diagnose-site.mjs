...
const CHECKS = [
  ...
  { id: 'frag-20-instance', label: 'Fragment 20 Manifold instance', pattern: /4035268848/ },
  ...
  { id: 'banner-gif', label: 'Stage II banner GIFs', pattern: /BannerGridDark-20-web\.gif[\s\S]{0,200}BannerGridLight-20-web\.gif/ },
  { id: 'site-audio', label: 'Site audio loop', pattern: /TogetherItBloomsAudio\.mp3/ },
  { id: 'asset-version', label: 'Site asset cache version', pattern: /20260724f20a/ },
  { id: 'canvas-state-latest', label: 'Theatre canvas state stills (latest CDN)', pattern: /canvasstatedark-20\.jpg|canvasstatelight-20\.jpg/ },
