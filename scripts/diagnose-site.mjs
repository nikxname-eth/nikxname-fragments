...
const CHECKS = [
  ...
  { id: 'frag-22-instance', label: 'Fragment 22 Manifold instance', pattern: /4038547696/ },
  ...
  { id: 'banner-gif', label: 'Stage II banner GIFs', pattern: /BannerGridDark-22-web\.gif[\s\S]{0,200}BannerGridLight-22-web\.gif/ },
  { id: 'site-audio', label: 'Site audio loop', pattern: /TogetherItBloomsAudio\.mp3/ },
  { id: 'asset-version', label: 'Site asset cache version', pattern: /20260729f22a/ },
  { id: 'canvas-state-latest', label: 'Theatre canvas state stills (latest CDN)', pattern: /canvasstatedark-22\.jpg|canvasstatelight-22\.jpg/ },
