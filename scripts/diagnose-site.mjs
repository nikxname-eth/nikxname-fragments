...
const CHECKS = [
  ...
  { id: 'frag-19-instance', label: 'Fragment 19 Manifold instance', pattern: /4035944688/ },
  ...
  { id: 'banner-gif', label: 'Stage II banner GIFs', pattern: /BannerGridDark-19-web\.gif[\s\S]{0,200}BannerGridLight-19-web\.gif/ },
  { id: 'site-audio', label: 'Site audio loop', pattern: /TogetherItBloomsAudio\.mp3/ },
  { id: 'asset-version', label: 'Site asset cache version', pattern: /20260722f19a/ },
  { id: 'canvas-state-19', label: 'Theatre canvas state stills (F19)', pattern: /canvasstatedark-19\.jpg[\s\S]{0,200}canvasstatelight-19\.jpg|canvasstatelight-19\.jpg[\s\S]{0,200}canvasstatedark-19\.jpg/ },
