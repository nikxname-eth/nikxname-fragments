              ...
              <div className={`project-about-drawer${projectAboutOpen ? ' open' : ''}`}>
                <div className="project-about-content">
                  ...
                  <div className="project-about-body">
                    ...
                    <br />
                    <p>
                      It challenges the instant-reveal culture of Web3 by unfolding as a slow burn. New pieces are released gradually over weeks and days, guided by a public countdown. Each release adds another fragment to the puzzle.
                    </p>
                    <br />
                    <p>Collectors who return and claim every piece become eligible for the primary work.</p>
                    <br />
                    <p>
                      The journey itself — showing up, waiting, discovering — is the art. Every step contributes to the living collection:
                    </p>
                  </div>
