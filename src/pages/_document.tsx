...
// ✏️  Update these when the collection or current piece changes
const META = {
  ...
  // OG image — the dark banner, ideal sharing preview
  // Cloudflare resizes to 1200×607 (matching 2500:1266 ratio)
  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* ── Open Graph (Facebook, iMessage, Discord, WhatsApp) ── */}
        ...
        {/* ── Favicon — puzzle piece SVG inline ── */}
        {/* This renders your E2.svg puzzle piece as the browser tab icon */}
        <link
          rel="icon"
          type="image/svg+xml"
        ...
        {/* Fallback PNG favicon for older browsers — 
            ✏️  optionally upload a 32×32 PNG to your R2 and swap this href */}
        ...
        {/* ── Manifold widget scripts ── */}
        <link rel="stylesheet" href="https://claims.manifoldxyz.dev/1.16.1/claimComplete.css" />
