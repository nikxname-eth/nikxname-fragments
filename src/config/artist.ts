...
export const SITE_ASSET_VERSION = '20260708f13a';
...
export const BANNER_GIF = {
  dark: 'https://assets.nikxart.xyz/BannerGridDark-13-web.gif',
  light: 'https://assets.nikxart.xyz/BannerGridLight-13-web.gif',
} as const;
