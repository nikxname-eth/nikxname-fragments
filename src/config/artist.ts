...
export const SITE_ASSET_VERSION = '20260710f14b';
...
export const BANNER_GIF = {
  dark: 'https://assets.nikxart.xyz/BannerGridDark-14-web.gif',
  light: 'https://assets.nikxart.xyz/BannerGridLight-14-web.gif',
} as const;
